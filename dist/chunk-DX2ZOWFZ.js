...
function FacilitatorShell({
  ...
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("header", { className: "h-14 px-6 flex items-center justify-between border-b border-[var(--sim-border)] bg-[var(--sim-surface-elevated)] shrink-0 z-10", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsx("span", { className: "font-semibold text-sm text-[var(--sim-text)]", children: simLabel }),
            /* @__PURE__ */ jsx("span", { className: "text-[var(--sim-text-muted)] text-sm", "aria-hidden": "true", children: "|" }),
          ...
          /* @__PURE__ */ jsxs(
            "div",
            {
              role: "status",
              "aria-live": "polite",
              className: `flex items-center gap-2 px-2.5 py-1 rounded-full text-xs font-medium ${isLive ? "bg-[var(--connection-live-bg)] text-[var(--connection-live-text)]" : "bg-[var(--connection-lost-bg)] text-[var(--connection-lost-text)]"}`,
              children: [
                /* @__PURE__ */ jsx(
                  "span",
                  {
                    className: `w-1.5 h-1.5 rounded-full ${isLive ? "bg-[var(--connection-live-dot)] animate-pulse" : "bg-[var(--connection-lost-dot)]"}`
                  }
                ),
        ...
        /* @__PURE__ */ jsxs(
          "div",
          {
            className: `flex-1 overflow-hidden ${rightPanel ? "grid grid-cols-[65fr_35fr]" : "flex flex-col"}`,
            children: [
              /* @__PURE__ */ jsx("div", { className: "flex-1 overflow-auto min-h-0", children }),
              rightPanel && /* @__PURE__ */ jsx("aside", { className: "overflow-auto border-l border-[var(--sim-border)] bg-[var(--sim-surface-elevated)]", children: rightPanel })
            ]
          }
        ),
